import { PUBLIC_API_URL, PUBLIC_WS_URL, PUBLIC_OIDC_AUTHORITY, PUBLIC_OIDC_CLIENT_ID, PUBLIC_OIDC_REDIRECT_URI, PUBLIC_MOCK, PUBLIC_STUDENT_INTERNET_FILTERING_ACTIVE } from '$env/static/public';
...
export const config = {
	...
	studentInternetFilteringActive:
		PUBLIC_STUDENT_INTERNET_FILTERING_ACTIVE === 'true' ||
		PUBLIC_STUDENT_INTERNET_FILTERING_ACTIVE === '1',
	oidc: {
