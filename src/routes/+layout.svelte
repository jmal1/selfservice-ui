...
<div class="relative flex h-screen overflow-hidden bg-surface-50-950">
	<!-- Animated background gradients (purple + blue blobs) -->
	...
	<aside class="glass fixed inset-y-0 left-0 z-30 flex w-64 flex-col">
		<!-- Logo -->
		<div class="flex items-center gap-3 border-b border-surface-200-800/30 px-5 py-5">
			<div class="glow-primary flex h-9 w-9 items-center justify-center rounded-[10px] bg-gradient-to-br from-primary-500 to-tertiary-500">
				<svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
			</div>
			<div>
				<span class="text-base font-bold text-surface-900-100">Self-Service</span>
				<span class="block text-[11px] text-surface-500">Lab Portal</span>
			</div>
		</div>
